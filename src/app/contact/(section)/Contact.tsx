  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
        <div className="flex w-full flex-col lg:flex-row">
          <div className="flex w-full flex-col gap-8 bg-[#000] px-6 lg:w-1/2 lg:px-28">
            <div className="flex flex-col gap-8">
              <h1 className="font-pathway text-4xl font-medium uppercase leading-[50px] tracking-[5px] text-[#DCCF90] lg:text-5xl">
                Get in
                <br /> Touch
              </h1>
            </div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
                  ...
                  <div className="flex w-full flex-col pt-7 lg:flex-row">
                    <Button
                      className="font-bai w-full rounded-2xl bg-[#DCCF90] py-6 text-[#000] hover:bg-[#a99948]"
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2366.9218214975285!2d-2.1904692238490138!3d53.61269717236772!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487bbb004af5d5ef%3A0x128b4665d794e81!2sEphesus%20-%20Authentic%20Turkish%20Cuisine!5e0!3m2!1sen!2sin!4v1733389141438!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
