    ...
    <section className="bg-menubg mt-8 flex w-full max-w-[1300px] flex-row">
      ...
      <div className="flex w-full flex-col gap-4 md:w-4/6">
        <div
          ...
          style={{
            background:
              "linear-gradient(170deg, rgba(0, 0, 0, 0.00) 7.51%, rgba(0, 0, 0, 0.80) 92.93%), url('/images/about-us/1.png') lightgray 50% / cover no-repeat",
          }}
        >
        ...
        {/* Categories */}
        <div className="sticky top-0 z-10 flex items-center bg-[#000] px-4 py-2">
          <div
            ref={categoryNavRef}
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      activeCategory === category._id
                        ...
                        : "border-[1px] border-menuprimary bg-transparent text-[#fff] hover:bg-menuprimary hover:text-menuforeground",
